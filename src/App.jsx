    ...
    <div style={{width:'100%', height:'100vh'}} className='d-flex justify-content-center align-items-center'>
      ...
      <div className='rounded p-3'>
          ...
          <div style={{marginTop:'200px'}} className='text-center'>
            ...
            <button onClick={()=>changeColor('bg-warning')} type="button" class="btn btn-warning me-2">Yellow</button>
             <button onClick={()=>changeColor('bg-info')} type="button" class="btn btn-info me-2">Skyblue</button>
          </div>
